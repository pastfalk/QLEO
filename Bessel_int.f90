...
subroutine Bessel_int(n,m,iarb,k,iperp,esc,Ivpe)
  ...
  !determine how many terms have to be included in the continued fraction formula that is used for the computation of the generalized hypergeometric function needed for the evaluation of the perpendicular velocity integral and determine whether arbitrary precision arithmetic has to be employed or not
